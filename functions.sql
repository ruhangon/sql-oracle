...
-- exemplo de function
create or replace function fqt_vdd return number is
wqt_vdd number;
begin
select count(*) into wqt_vdd from vendedor;
return wqt_vdd;
end;
/

-- mostra o resultado da função acima
begin
dbms_output.put_line('Total de vendedores: '||fqt_vdd);
end;
/
